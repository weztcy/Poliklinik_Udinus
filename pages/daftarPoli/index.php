    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-primary">
                <div class="card-header bg-dark"> <!-- Menambahkan bg-dark pada header -->
                    <h3 class="card-title text-white">Daftar Poli</h3> <!-- Menambahkan text-white pada teks -->
                </div>
                <div class="card-body">
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header bg-dark"> <!-- Menambahkan bg-dark pada header -->
                    <h3 class="card-title text-white">Riwayat Daftar Poli</h3> <!-- Menambahkan text-white pada teks -->
                </div>
